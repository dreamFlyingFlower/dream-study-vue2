<template>
  <div>
    ...
    <div v-if="ok">这是if 的测试</div>
    <div v-show="!ok">这是show的测试</div>
    <input v-model.lazy="msg" @change="change();" />
...
export default {
  ...
  data () {
    return {
      ...
      tem:tem,
      ok:true,
      testhtml:"<a href='https://www.baidu.com' target='_blank'>this is a test</a>"
    }
  },
  methods:{
    testii(){
...
var tem = {
  template:"<span @click='gaibian'>{{test}}</span>",
  props:['test'],
  methods:{
    gaibian:function(){
      test+=1;
